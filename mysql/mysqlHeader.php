    ...
    <body>
        ...
        <div class="sidebar">
            <ul class="sidebarList">
                ...
                <!-- <a class="sidebarItems" id="link5" href="/var/www/test/tracker.php" target="_self">Spamtrap Hit Tracker</a> -->
                <a class="sidebarItems" id="link5" href="tracker.php" target="_self">Spamtrap Hit Tracker</a>
                <a class="sidebarItems" id="link6" href="mysqlTracker.php" target="_self">mysqlTracker</a>
            </ul>
        </div>
